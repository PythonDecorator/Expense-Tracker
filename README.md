...
This repo contains a fully built and deployed Expense Tracker with Python, Javascript & Django.

# [Expense-Tracker](https://github.com/PythonDecorator/Expense-Tracker)
...
```bash
$ git clone https://github.com/PythonDecorator/Expense-Tracker.git
$ cd Expense-Tracker
```
...
GitHub Issues IS the official bug tracker for the **Expense-Tracker**. Here are some advices for users that want
to report an issue:

1. Make sure that you are using the latest version of the **Expense-Tracker**. Check the CHANGELOG
...
---
[Expense-Tracker](https://google.com) - Provided by PythonDecorator
